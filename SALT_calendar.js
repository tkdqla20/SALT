...
function test() {
	var googleCalendarApiKey = document.getElementById('id');
	var googleCalendarId = document.getElementById('password');
	localStorage.setItem(googleCalendarApiKey, googleCalendarId)
}